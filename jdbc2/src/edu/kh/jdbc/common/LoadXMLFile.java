...
public class LoadXMLFile {
	public static void main(String[] args) { // Map<String, String>
		...
		try {
			 ...
			 * 		(파일의 내용을 읽어오는 코드만 작성해두면 Java 코드 수정 없이, 파일 내용만 수정하면
			 * 	     재 컴파일은 수행되지 않는다.)
			 * 
			 * 4. SQL 분리
			 *  - XML 파일에 작성된 문자열 형태를 그대로 읽어오기 때문에 SQL 작성 시 좀 더 편리해진다. 
			 * */
		}catch (Exception e) {
			e.printStackTrace();
		}
