...
public class TestService {
	...
	public int insert(TestVO vo1) throws SQLException {
		...
		// INSERT DAO 메서드 호출하여 수행 후 결과 반환 받기
		// -> Service에서 생성한 Connection 객체를 반드시 같이 전달해야 함
	...
	public int insert(TestVO vo1, TestVO vo2, TestVO vo3) throws Exception {
		// throws Exception
		// -> 아래 catch문에서 강제 발생된 에외를
		//    호출부로 던진다는 구문
		//    throws 보다 try ~ catch의 우선순위가 더 높기 때문에
		//    try안에서 발생한 예외는 catch에서 처리하고 catch에서 강제발생한 예외는 throws 구문을 통해 넘긴다.
